...
def doNLTK():
    def doStem():
        ...
        stemmed_tkn_list = ts.main("../Data/ziji_posts.txt", True)
        unstemmed_tkn_list = ts.main("../Data/ziji_posts.txt", False)
...
def doIrregularCheck():
    ...
    def doTokenize():
        ...
        myTokens = analyser.Analyser("../Data/all_posts_clean_predict_tokenized.txt",
                                     "../Data/all_answers_clean_predict_tokenized.txt")
